...
import { login, setEmployerProfile } from '../redux/authSlice';
        ...
        onSubmit:async(values)=>{
          console.log("Submit clicked!")
            ...
            toast.success(data?.message || "Login successful!");
              ...
              dispatch(setEmployerProfile(data.employerProfile));
              
              const role = data.user.role; // or data.user.roles, depending on your API
